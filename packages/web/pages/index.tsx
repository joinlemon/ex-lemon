    ...
    <div>
      ...
      <main className="mt-0">
        <section className="mt-14 mb-6 rounded-xl mx-6 gradient-section flex flex-col items-center justify-center">
          ...
          <h2 className="font-light text-2xl text-white drop-shadow">Dolor sit amet, consecetur elit</h2>
          <div className="flex m-2">
            <button className="px-4 py-2 m-2 bg-white text-black rounded hover:bg-white/70 hover:shadow-xl">Amet</button>
            <button className="px-4 py-2 m-2 bg-blue-900 text-white font-bold rounded hover:bg-blue-900/70 hover:shadow-xl">Elit nullam</button>
          </div>
        </section>
        <section className="h-96 w-full quiet-section flex flex-col p-16">
          <h2 className="font-black text-4xl text-black drop-shadow">Dolor sit amet, consecetur elit</h2>
          <div className="flex">
